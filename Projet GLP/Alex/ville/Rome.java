...
public class Rome extends JFrame {
	 ...
	 */
	public Rome() {
		Ports a = new Ports("Rome",65480,3000,5000,7000,2000,4);
		setResizable(false);
		setTitle(a.getName());
		...
		lblNewLabel_1.setIcon(new ImageIcon(Rome.class.getResource("/images/Rome.jpg")));
		...
		JLabel lblDescriptionDeLa = new JLabel("Description de la ville : Rome est une très belle ville");
