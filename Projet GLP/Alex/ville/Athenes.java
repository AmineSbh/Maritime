...
public class Athenes extends JFrame {
	...
	public Athenes() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(Athenes.class.getResource("/images/athenes.png")));
		...
		JLabel lblDescriptionDeLa = new JLabel("Description de la ville : Ath\u00E8ne est une cit\u00E9 agr\u00E9able \u00E0 visiter");
