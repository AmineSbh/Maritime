...
import evenements.bataille;
import evenements.marché;
import evenements.negociation;
...
public class LeCaire extends JFrame {
	 ...
	 */
	public LeCaire() {
		Ports a = new Ports("LeCaire",6500,3000,5000,7000,2000,2);
		setResizable(false);
		setTitle(a.getName());
		...
		lblNewLabel_1.setIcon(new ImageIcon(LeCaire.class.getResource("/images/LeCaire.jpeg")));
		panel.add(lblNewLabel_1);
		
		JLabel lblAthnes = new JLabel(a.getName());
		...
		JLabel lblDescriptionDeLa = new JLabel("Description de la ville : Il fait plutôt chaud au Caire.");
		...
		JLabel lblNewLabel = new JLabel("Valeur estim\u00E9e du port : " + a.getValeurVille());
		lblNewLabel.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel.setBounds(313, 14, 236, 30);
		contentPane.add(lblNewLabel);
		
		JLabel lblLeNiveauDu = new JLabel("Le niveau du port est: " + a.getLevel());
