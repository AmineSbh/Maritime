...
public class Sparte extends JFrame {
	 ...
	 */
	public Sparte() {
		Ports a = new Ports("Sparte",0,3000,5000,7000,2000,4);
		setResizable(false);
		setTitle(a.getName());
		...
		lblNewLabel_1.setIcon(new ImageIcon(Sparte.class.getResource("/images/Sparte.png")));
		...
		JLabel lblDescriptionDeLa = new JLabel("Description de la ville : Attention grand danger !");
